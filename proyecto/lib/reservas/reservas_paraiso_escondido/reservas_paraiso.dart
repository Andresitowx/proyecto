...
import 'package:proyecto/reservas/reservas_paraiso_escondido/servicios_paraiso.dart';

// Página principal de lista de alojamientos
class ReservasParaiso extends StatelessWidget {
  @override
                ...
                child: ListView(
                  children: [
                    buildAccommodationCard(
                      context,
                      'cabaña del arbol ',
                      'tu reserva va a contener todo a contener todos los servicios',
                      '180.000',
                    ),
                    buildAccommodationCard(
                      context,
                      'paraiso escondido',
                      'trae todas las comodidades para tu estadia menos comidas',
                      '180.000',
                    ),
                    buildAccommodationCard(
                      context,
                      'parque pijao',
                      'hospedaje y aventuras',
                      '120.000',
                    ),
                  ],
                ),
    ...
    return Card(
      child: ListTile(
        ...
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => ServiciosParaiso()),
          );
        },
      ),
    );
